...
async def pay_with_stars(callback: CallbackQuery, bot: Bot):
    ...
    # Stars narxi taxminiy: 1 Stars ≈ o'zingiz belgilagan kursda. Bu yerda oddiy formula ishlatilgan.
    stars_amount = max(1, round(price_som / 200))  # kursni config'da moslashtirishingiz mumkin
